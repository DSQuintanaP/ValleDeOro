...
{
    [DbContext(typeof(GvglampingContext))]
    partial class GvglampingContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ValleDeOro.Models.Abono", b =>
                {
                    ...
                    b.HasKey("IdAbono")
                        .HasName("PK__Abono__A4693DA7A09D6923");
            ...
            modelBuilder.Entity("ValleDeOro.Models.Cliente", b =>
                {
                    ...
                    b.HasKey("NroDocumento")
                        .HasName("PK__Clientes__CC62C91C37319598");
            ...
            modelBuilder.Entity("ValleDeOro.Models.DetalleReservaPaquete", b =>
                {
                    ...
                    b.HasKey("DetalleReservaPaquete1")
                        .HasName("PK__DetalleR__2E8BFF25F75AACB1");
            ...
            modelBuilder.Entity("ValleDeOro.Models.DetalleReservaServicio", b =>
                {
                    ...
                    b.HasKey("IdDetalleReservaServicio")
                        .HasName("PK__DetalleR__D3D91A5A08BCC4D4");
            ...
            modelBuilder.Entity("ValleDeOro.Models.EstadosReserva", b =>
                {
                    ...
                    b.HasKey("IdEstadoReserva")
                        .HasName("PK__EstadosR__3E654CA8EEF1FB6D");

                    b.ToTable("EstadosReserva", (string)null);
                });

            modelBuilder.Entity("ValleDeOro.Models.Habitacione", b =>
                {
                    ...
                    b.HasKey("IdHabitacion")
                        .HasName("PK__Habitaci__8BBBF90169F7EDE9");
            ...
            modelBuilder.Entity("ValleDeOro.Models.ImagenAbono", b =>
                {
                    ...
                    b.HasKey("IdImagenAbono")
                        .HasName("PK__ImagenAb__A40FAE53D797E305");
            ...
            modelBuilder.Entity("ValleDeOro.Models.ImagenHabitacion", b =>
                {
                    ...
                    b.HasKey("IdImagenHabi")
                        .HasName("PK__ImagenHa__5B5FF6ADC08B6613");
            ...
            modelBuilder.Entity("ValleDeOro.Models.ImagenPaquete", b =>
                {
                    ...
                    b.HasKey("IdImagenPaque")
                        .HasName("PK__ImagenPa__AD53DF944CAE36D6");
            ...
            modelBuilder.Entity("ValleDeOro.Models.ImagenServicio", b =>
                {
                    ...
                    b.HasKey("IdImagenServi")
                        .HasName("PK__ImagenSe__3C03784C0CD215C6");
            ...
            modelBuilder.Entity("ValleDeOro.Models.Imagene", b =>
                {
                    b.Property<int>("IdImagen")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdImagen")
                        .HasName("PK__Imagenes__B42D8F2A03FBD281");

                    b.ToTable("Imagenes");
                });

            modelBuilder.Entity("ValleDeOro.Models.MetodoPago", b =>
                {
                    ...
                    b.HasKey("IdMetodoPago")
                        .HasName("PK__MetodoPa__6F49A9BE5E1CC485");

                    b.ToTable("MetodoPago", (string)null);
                });

            modelBuilder.Entity("ValleDeOro.Models.Paquete", b =>
                {
                    b.Property<int>("IdPaquete")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdPaquete")
                        .HasName("PK__Paquetes__DE278F8BEF81B661");
            ...
            modelBuilder.Entity("ValleDeOro.Models.PaqueteServicio", b =>
                {
                    ...
                    b.HasKey("IdPaqueteServicio")
                        .HasName("PK__PaqueteS__DE5C2BC2CB321C96");
            ...
            modelBuilder.Entity("ValleDeOro.Models.Permiso", b =>
                {
                    ...
                    b.HasKey("IdPermiso")
                        .HasName("PK__Permisos__0D626EC87EDBDF3B");

                    b.ToTable("Permisos");
                });

            modelBuilder.Entity("ValleDeOro.Models.PermisosRole", b =>
                {
                    ...
                    b.HasKey("IdPermisosRoles")
                        .HasName("PK__Permisos__8C257ED9F00B1085");
            ...
            modelBuilder.Entity("ValleDeOro.Models.Reserva", b =>
                {
                    b.Property<int>("IdReserva")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdReserva")
                        .HasName("PK__Reservas__0E49C69DC61D1C84");
            ...
            modelBuilder.Entity("ValleDeOro.Models.Role", b =>
                {
                    b.Property<int>("IdRol")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdRol")
                        .HasName("PK__Roles__2A49584CFA603911");

                    b.ToTable("Roles");
                });

            modelBuilder.Entity("ValleDeOro.Models.Servicio", b =>
                {
                    b.Property<int>("IdServicio")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdServicio")
                        .HasName("PK__Servicio__2DCCF9A2C83BF525");
            ...
            modelBuilder.Entity("ValleDeOro.Models.TipoDocumento", b =>
                {
                    b.Property<int>("IdTipoDocumento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdTipoDocumento")
                        .HasName("PK__TipoDocu__3AB3332F84FFA246");

                    b.ToTable("TipoDocumento", (string)null);
                });

            modelBuilder.Entity("ValleDeOro.Models.TipoHabitacione", b =>
                {
                    b.Property<int>("IdTipoHabitacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdTipoHabitacion")
                        .HasName("PK__TipoHabi__AB75E87CABB617B4");

                    b.ToTable("TipoHabitaciones");
                });

            modelBuilder.Entity("ValleDeOro.Models.TipoServicio", b =>
                {
                    b.Property<int>("IdTipoServicio")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdTipoServicio")
                        .HasName("PK__TipoServ__E29B3EA7C54560A1");
            ...
            modelBuilder.Entity("ValleDeOro.Models.Abono", b =>
                {
                    b.HasOne("ValleDeOro.Models.Reserva", "IdReservaNavigation")
                        .WithMany("Abonos")
            ...
            modelBuilder.Entity("ValleDeOro.Models.Cliente", b =>
                {
                    b.HasOne("ValleDeOro.Models.Role", "IdRolNavigation")
                        .WithMany("Clientes")
                        .HasForeignKey("IdRol")
                        .HasConstraintName("FK__Clientes__IdRol__5EBF139D");

                    b.HasOne("ValleDeOro.Models.TipoDocumento", "IdTipoDocumentoNavigation")
                        .WithMany("Clientes")
            ...
            modelBuilder.Entity("ValleDeOro.Models.DetalleReservaPaquete", b =>
                {
                    b.HasOne("ValleDeOro.Models.Paquete", "IdPaqueteNavigation")
            ...
            modelBuilder.Entity("ValleDeOro.Models.DetalleReservaServicio", b =>
                {
                    ...
                    b.HasOne("ValleDeOro.Models.Servicio", "IdServicioNavigation")
                        .WithMany("DetalleReservaServicios")
            ...
            modelBuilder.Entity("ValleDeOro.Models.Habitacione", b =>
                {
                    b.HasOne("ValleDeOro.Models.TipoHabitacione", "IdTipoHabitacionNavigation")
            ...
            modelBuilder.Entity("ValleDeOro.Models.ImagenAbono", b =>
                {
                    b.HasOne("ValleDeOro.Models.Abono", "IdAbonoNavigation")
                        .WithMany("ImagenAbonos")
                        .HasForeignKey("IdAbono")
                        .HasConstraintName("FK__ImagenAbo__IdAbo__797309D9");

                    b.HasOne("ValleDeOro.Models.Imagene", "IdImagenNavigation")
                        .WithMany("ImagenAbonos")
            ...
            modelBuilder.Entity("ValleDeOro.Models.ImagenHabitacion", b =>
                {
                    b.HasOne("ValleDeOro.Models.Habitacione", "IdHabitacionNavigation")
            ...
            modelBuilder.Entity("ValleDeOro.Models.PermisosRole", b =>
                {
                    b.HasOne("ValleDeOro.Models.Permiso", "IdPermisoNavigation")
            ...
            modelBuilder.Entity("ValleDeOro.Models.Reserva", b =>
                {
                    b.HasOne("ValleDeOro.Models.EstadosReserva", "IdEstadoReservaNavigation")
                        .WithMany("Reservas")
                        .HasForeignKey("IdEstadoReserva")
                        .HasConstraintName("FK__Reservas__IdEsta__693CA210");

                    b.HasOne("ValleDeOro.Models.MetodoPago", "MetodoPagoNavigation")
                        .WithMany("Reservas")
                        .HasForeignKey("MetodoPago")
                        .HasConstraintName("FK__Reservas__Metodo__6A30C649");

                    b.HasOne("ValleDeOro.Models.Cliente", "NroDocumentoClienteNavigation")
                        .WithMany("Reservas")
            ...
            modelBuilder.Entity("ValleDeOro.Models.Servicio", b =>
                {
                    b.HasOne("ValleDeOro.Models.TipoServicio", "IdTipoServicioNavigation")
                        .WithMany("Servicios")
